use crust_boot_you::{
    app_traits::file_manipulator::{DevOsFileManipulator, OsFileManipulator},
    prelude::*,
};
...
impl TestSetup {
    pub fn new(actual_expected: (PathBuf, PathBuf)) -> Self {
        ...
        Self {
            ...
            os_mani: DevOsFileManipulator::new(&path_to_temp),
            temp_file,
            path_to_temp,
            actual,
            expected,
